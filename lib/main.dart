...
void main() async {
  ...
  // ✅ طلب إذن الإشعارات (أندرويد 13+) — إجباري وإلا لن تظهر
  // إشعارات "طلب جديد" الخلفية للأدمن إطلاقاً على الأجهزة الحديثة.
  // ملاحظة: يتطلب flutter_local_notifications الإصدار 16 فما فوق.
  // إن ظهر خطأ ترجمة، استبدل requestNotificationsPermission بـ requestPermission
  if (!kIsWeb) {
    try {
